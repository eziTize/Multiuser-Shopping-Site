...
<div class="bg-blue-700 py-32 h-full" id="checkout">
    ...
    <div v-else class="container mx-auto px-6 flex justify-around items-center ">
        ...
        <form @submit.prevent="makeOrder" class="w-full max-w-lg">
