      ...
      <form method="POST" role="form" class="w-full" action="{{ Asset($link.'store')}}" enctype="multipart/form-data">
        ...
        @csrf
         ...
         <div class="flex flex-wrap mb-6">
           ...
           <div class="flex flex-wrap mb-6">
              ...
              <input type="file" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="product_image" type="text" name="image" accept=".jpeg,.jpg,.png" onchange="checkextension()">
            <!--   <p class="text-gray-600 text-xs italic">Remove if not needed</p> -->
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="price" type="number" placeholder="Numbers Only" name="price" step=".01" min="0" value="{{ old('price') }}" required>
            </div>

             <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-black text-xs font-bold mb-2" for="mrp">
                    MRP (INR)
                </label>
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="mrp" type="number" placeholder="Numbers Only" name="mrp" step=".01" min="0" value="{{ old('mrp') }}">
            </div>
            ...
            <div class="w-full md:w-1/3 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="units" type="number" min="0" name="units" placeholder="Numbers Only" value="{{ old('units') }}">
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full px-3">
                ...
                <textarea class="no-resize appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-y" id="description" name="description">{{ old('description') }}</textarea>
        ...
        <div class="flex flex-wrap mb-6 px-3 relative inline-flex">
          ...
          <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" name="category_name" value="{{ old('category_name') }}" required>
