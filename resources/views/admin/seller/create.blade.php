...
@section('title') Add New Seller @endsection
...
@section('content')
      ...
      <form method="POST" role="form" class="w-full" action="{{ route('seller.store') }}" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap mb-6">
          ...
          <select class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 focus:outline-none focus:bg-white" name="gender" value="{{ old('gender') }}">
         ...
         <div class="flex flex-wrap mb-6">
              ...
              <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="address" type="text" name="address" value="{{ old('address') }}" placeholder="Seller Address" required>
            <!--   <p class="text-gray-600 text-xs italic">Remove if not needed</p> -->
            </div>
          </div>
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="phone" type="number" placeholder="Seller Phone Number" name="phone" min="0" value="{{ old('phone') }}" >
            </div>
        ...
        <div class="w-full md:w-1/2 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email" name="email" placeholder="Seller Email" value="{{ old('email') }}">
            </div>
        </div>
        ...
        <div class="flex flex-wrap mb-6">
          ...
          <!-- <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
               <label class="block uppercase tracking-wide text-black text-xs font-bold mb-2" for="profit_percent">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="profit_percent" type="number" placeholder="Enter % Profit for Seller" name="profit_percent" min="0" value="{{ old('profit_percent') }}" >
            </div> -->
            ...
            <div class="w-full px-3 mb-6 md:mb-0">
              ...
              <select class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 focus:outline-none focus:bg-white" name="status" value="{{ old('status') }}">
