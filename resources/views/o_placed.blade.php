...
<div class="text-gray-900 bg-gray-200">
    ...
    <div class="pt-20 pb-10 flex justify-center">
        <h1 class="text-3xl text-green-500">
		 ...
		 <p class="text-center pb-10 text-gray-600 px-2"> Thank you for placing your Order with us, the product will be delivered to the address provided on the order form, if you want to change the delivery address then please contact us at <a href="mailto:sandipan21saha@yahoo.com" class="text-blue-500"><b>sandipan21saha@yahoo.com</b></a>. </p>
